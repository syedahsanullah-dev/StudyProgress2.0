      ...
      <div className="flex-1 flex flex-col sm:ml-20 pb-20 sm:pb-0 min-h-screen" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 max-w-7xl mx-auto w-full space-y-6">
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 shadow-xl">
            <div className="datesheet-header mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                <h2 className="text-xl font-bold text-white flex items-center gap-2">
                  <Calendar className="text-indigo-400" />
                  Exam Schedule
                </h2>
                <p className="text-slate-400 text-sm mt-1">Your confirmed exam dates, sessions, and preparation days.</p>
              </div>
              {activeSem && (
                <div className="self-start sm:self-auto px-3.5 py-1.5 rounded-full bg-indigo-500/15 border border-indigo-500/30 text-indigo-300 font-bold text-xs">
                  {activeSem.name}
                </div>
              )}
            </div>
